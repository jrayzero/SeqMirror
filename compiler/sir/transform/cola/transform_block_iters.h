...
// various note: scans should only take block/view types
// if you don't wrap it in a scan, i'll ignore it


// ranges become _compiler_iter_tuplefy(__iter__(range)) and scans becomes _compiler_scan(__iter__(obj))
struct CanonicalizeLoops : public OperatorPass {
